...
//
// import { GlobalProcessor, globalProcessor } from '@brick/processor';
//
// // 去除Observable类型
...
import { GlobalProvider, useGlobalSelector } from '@brick/processor';

export { GlobalProvider, useGlobalSelector };
