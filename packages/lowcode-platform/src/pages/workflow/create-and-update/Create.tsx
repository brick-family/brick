...
import { ENodeType, EWorkflowType, IWorkflowEntity } from '@brick/types';
...
import { NODE_HEIGHT, NODE_WIDTH } from '@brick/workflow';
        ...
        onFinish={async (values: IWorkflowEntity) => {
          try {
            ...
            if (modalData.type === 'create') {
              ...
              values.graph = TypeData.find((f) => f.id == currType)?.defaultGraph;
            }
